...
** xref:02-architecture.adoc#tech_stack[{module}.{counter:submodule2}. Common Challenges]
...
** xref:03-demo.adoc#_demonstration[{module}.{counter:submodule3}. Setup the solution]
** xref:03-demo.adoc#_run_the_demonstration[{module}.{counter:submodule3}. Workshop Walkthrough guide]
*** xref:03-demo.adoc#_before_getting_started[{module}.{counter:submodule3}. Conclusion]
